...
describe("library works", function() {
    ...
    beforeEach(function() {
        get("/bibliotek")
        return (rows = element.all(
            By.repeater("row in listVisibleTitles() | filter:mediatypeFilter")
        ))
    })
    ...
    it("should correctly handle pagestep", function() {
        ...
        return element(By.css(".pager_ctrls a[rel=next]"))
            ...
            .then(function(linkUrl) {
                browser.get(linkUrl)
                return expect(browser.getCurrentUrl()).toBe(
    ...
    it("should change page on click", function() {
        ...
        return element(By.css(".pager_ctrls a[rel=next]"))
            ...
            .then(function() {
                ...
                return expect(element(By.css("img.faksimil")).getAttribute("src")).toEqual(
...
describe("parts navigation", function() {
    ...
    it("should handle parts with parent parts", function() {
        ...
        return expect(prevPart().getAttribute("href")).toBe(
    ...
    it("should handle many parts on same page, next", function() {
        ...
        return expect(nextPart().getAttribute("href")).toBe(
