...
Expected before fixing the SO modal issue: `31 passed` and one failure for `Reader > should show SO modal`.
...
E2E: npm test -- --reporter=list produced 31 passed, 1 known SO modal failure.
