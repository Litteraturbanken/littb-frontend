...
Expected before fixing the SO modal issue: `28 passed` and one failure for `Reader > should show SO modal`.
...
E2E: npm test -- --reporter=list produced 28 passed, 1 known SO modal failure.
