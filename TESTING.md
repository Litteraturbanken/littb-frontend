...
- **Total Tests**: 29 tests across 10 describe blocks
...
Current `Syntax` baseline: 28 of 29 tests pass. The known failing test is `Reader > should show SO modal`, which depends on the SO modal flow and should be fixed or quarantined separately.
...
**Required**: Current `Syntax` baseline is 29 total tests, with 28 passing and known failing test `Reader > should show SO modal` unless it has been fixed or quarantined.
...
**Command**: `npx playwright test`
**Required**: Current `Syntax` baseline applies: 28 of 29 tests pass, with known failing test `Reader > should show SO modal` unless fixed or quarantined.
...
**Command**: `npx playwright test`
**Required**: Current `Syntax` baseline applies: 28 of 29 tests pass, with known failing test `Reader > should show SO modal` unless fixed or quarantined; include performance validation.
...
4. Only proceed when the suite is back to the current baseline: 29 total tests, 28 passing, with only `Reader > should show SO modal` failing unless it has been fixed or quarantined.
