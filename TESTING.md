...
**Required**: Current `Syntax` baseline is 31 total tests, with 30 passing and known failing test `Reader > should show SO modal` unless it has been fixed or quarantined.
...
**Command**: `npx playwright test`
**Required**: Current `Syntax` baseline applies: 30 of 31 tests pass, with known failing test `Reader > should show SO modal` unless fixed or quarantined.
...
**Command**: `npx playwright test`
**Required**: Current `Syntax` baseline applies: 30 of 31 tests pass, with known failing test `Reader > should show SO modal` unless fixed or quarantined; include performance validation.
...
4. Only proceed when the suite is back to the current baseline: 31 total tests, 30 passing, with only `Reader > should show SO modal` failing unless it has been fixed or quarantined.
