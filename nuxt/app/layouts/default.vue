...
<template>
  <div class="site-shell">
    <div id="leftCorridor">
      <NuxtLink class="logo_link_monogram block" to="/" aria-label="Litteraturbanken">
        <svg
      ...
      <ul class="start-only flex space-x-2 uppercase text-sm align-right antialiased justify-end mr-32 font-display">
        <li><NuxtLink to="/om/english.html">English</NuxtLink></li>
        <li><NuxtLink to="/om/deutsch.html">Deutsch</NuxtLink></li>
        <li><NuxtLink to="/om/francais.html">Français</NuxtLink></li>
      </ul>
      <a
