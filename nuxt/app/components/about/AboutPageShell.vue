...
<template>
  ...
  <ul class="links">
    ...
    <li><NuxtLink :class="{ active: activePage === 'statistik' }" :prefetch="false" to="/om/statistik">Statistik</NuxtLink></li>{{ " " }}
    <li><NuxtLink :class="{ active: activePage === 'kontakt' }" :prefetch="false" to="/om/kontakt">Kontakt</NuxtLink></li>
  </ul>
  <slot />
</template>
