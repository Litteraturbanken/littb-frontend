...
function libraryPdfWork({
  ...
  return {
    ...
    shorttitle: title,
    title: id === "RodaRummet"
      ? `${title}. Skildringar ur artist- och författarlivet`
      : `${title}. Roman`,
    texttype: "roman",
    mediatype,
    startpagename: "1",
    ...
    export: [{ type: "pdf", url, filename, size }]
  }
}

const exportedPdfWork = libraryPdfWork({
...
const indexedPdfWork = libraryPdfWork({
  id: "RodaRummet",
...
const pageTwoPdfWork = libraryPdfWork({
  id: "DoktorGlas",
  authorId: "SoderbergH",
  ...
  year: "1905",
  title: "Doktor Glas",
  url: "https://litteraturbanken.se/txt/lb-DoktorGlas/lb-DoktorGlas.pdf",
  filename: "SoderbergH_DoktorGlas",
  size: 1_720_419
})

const libraryPdfPageOneResponse = {
  data: [exportedPdfWork, indexedPdfWork],
  hits: 201,
  distinct_hits: 201,
  suggest: []
}
const libraryPdfPageTwoResponse = {
  data: [pageTwoPdfWork],
  hits: 201,
  distinct_hits: 201,
  suggest: []
}
const libraryPdfFilteredResponse = {
  data: [exportedPdfWork],
  hits: 1,
  distinct_hits: 1,
  suggest: []
}
const libraryPdfEmptyResponse = { data: [], hits: 0, distinct_hits: 0, suggest: [] }
const libraryPdfMalformedEnvelopeResponse = {
  data: "invalid",
  hits: 0,
  distinct_hits: 0,
  suggest: []
}
const libraryPdfMalformedRowResponse = {
  data: [
    exportedPdfWork,
    null,
    ...
    libraryPdfWork({
      ...
      url: "/txt/lb-UnsafeAuthor/lb-UnsafeAuthor.pdf",
      filename: "UnsafeAuthor",
      size: 10
    }),
    {
      ...libraryPdfWork({
        ...
        year: "1902",
        title: "Osäker titel",
        url: "/txt/lb-UnsafeTitle/lb-UnsafeTitle.pdf",
        filename: "UnsafeTitle",
        size: 11
      }),
      titleid: "Unsafe/Title",
      work_titleid: "Unsafe/Title"
    },
    {
      ...libraryPdfWork({
        id: "UnsafeMedia",
        ...
        surname: "Säker",
        year: "1903",
        title: "Osäkert medium",
        url: "/txt/lb-UnsafeMedia/lb-UnsafeMedia.pdf",
        filename: "UnsafeMedia",
        size: 12
      }),
      mediatype: "../pdf"
    },
    libraryPdfWork({
      ...
      year: "1904",
      title: "Osäker URL",
      url: "https://example.test/unsafe.pdf",
      filename: "UnsafeUrl",
      size: 13
    }),
    libraryPdfWork({
      ...
      surname: "Säker",
      year: "1905",
      title: "Osäkert filnamn",
      url: "/txt/lb-UnsafeFilename/lb-UnsafeFilename.pdf",
      filename: "../unsafe.pdf",
      size: 14
    }),
    {
      ...libraryPdfWork({
        id: "DuplicateDownloads",
        authorId: "SafeA",
        fullName: "Säker Författare",
        surname: "Säker",
        year: "1906",
        title: "Dubbla hämtningar",
        url: "/txt/lb-DuplicateDownloads/lb-DuplicateDownloads.pdf",
        filename: "DuplicateDownloads",
        size: 15
      }),
      export: [
        {
        ...
        {
          type: "pdf",
          url: "https://litteraturbanken.se/txt/lb-DuplicateDownloads/alternate.pdf",
          filename: "DuplicateDownloadsAlternate",
          size: 16
        }
      ]
    }
...
function libraryPdfResponse(query) {
