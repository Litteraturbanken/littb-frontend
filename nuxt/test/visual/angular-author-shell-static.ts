...
/**
 * Closed list of Angular author-shell modules and styles that are required for
 * a faithful visual authority capture. Keep capture routes on this list rather
 * than admitting arbitrary application requests.
 */
export const allowedAuthorShellStaticRequests = new Set([
