...
test("valid history is filtered before the 50-row limit and resolved once in stored order", async ({
  ...
  const unsafe: unknown[] = [
    ...
    { author: "Bad/Author", label: "Slash author", url: "/slash-author" },
    { author: "Bad\\Author", label: "Backslash author", url: "/backslash-author" },
    { author: "Bad%2FAuthor", label: "Encoded author", url: "/encoded-author" },
    { author: "Bad\u0001Author", label: "Control author", url: "/control-author" },
    { author: "Bad\uD800Author", label: "Surrogate author", url: "/surrogate-author" },
