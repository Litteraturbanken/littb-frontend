 ...
 */
angular
    .module("dibari.angular-ellipsis", [])
                            ...
                            if (typeof scope.ngBind !== "undefined") {
                                var bindArray = scope.ngBind.split(" "),
                                    ...
                                    ellipsisSymbol =
                                        typeof attributes.ellipsisSymbol !== "undefined"
                                            ...
                                            : "&hellip;",
                                    appendString =
                                        typeof scope.ellipsisAppend !== "undefined" &&
                                ...
                                if (isOverflowed(element)) {
                                    ...
                                    for (; i < bindArrayStartingLength; i++) {
                                        ...
                                        if (
                                            element[0].scrollHeight < initialMaxHeight ||
                                            isOverflowed(element) === false
                                        ) {
